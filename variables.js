...
var colNameTranslate = {
    ...
    'const_code': {
        'EN': 'Constituency code',
        'MM': 'မဲဆန္ဒနယ်ကုဒ်'
    },
    'const_name': {
        'EN': 'Constituency name',
        'MM': 'မဲဆန္ဒနယ်အမည်'
    },
    'candidate_name.en': {
        'EN': 'Candidate name',
        'MM': 'ကိုယ်စားလှယ်လောင်းအမည်'
    },
    'candidate_name.my': {
        'EN': 'Candidate name',
        'MM': 'ကိုယ်စားလှယ်လောင်းအမည်'
...
var conTable = {
    'table' : {
    'EN': '["name_st", "const_code", "const_name", "candidate_name.en", "party_name.en", "votes.total_valid"]',
    'MM': '["name_st", "const_code", "const_name", "candidate_name.my", "party_name.my", "votes.total_valid"]'
}
}
...
var yearInfo = {'2020':[{'Held on':'8 Nov 2020','Available seats':'1171','President':'Win Myint','link':'https://en.wikipedia.org/wiki/Win_Myint','source':'https://en.wikipedia.org/wiki/2020_Myanmar_general_election'}],
                '2015':[{'Held on':'8 Nov 2015','Available seats':'1557','President':'Htin Kyaw','link':'https://en.wikipedia.org/wiki/Htin_Kyaw','source':'https://en.wikipedia.org/wiki/2015_Myanmar_general_election'}],
                '2010':[{'Held on':'7 Nov 2010','Available seats':'1544','President':'Thein Sein', 'link':'https://en.wikipedia.org/wiki/Thein_Sein','source':'https://en.wikipedia.org/wiki/2010_Myanmar_general_election'}],
                '2012':[{'Held on':'1 April 2012','Available seats':'48','President':'Thein Sein', 'link':'https://en.wikipedia.org/wiki/Thein_Sei','source':'https://en.wikipedia.org/wiki/2012_Myanmar_by-elections'}],
                '2017':[{'Held on':'1 Apr 2017','Available seats':'19','President':'Htin Kyaw', 'link':'https://en.wikipedia.org/wiki/Htin_Kyaw','source':'https://en.wikipedia.org/wiki/2017_Myanmar_by-elections'}],
                '2018':[{'Held on':'3 Nov 2018','Available seats':'13','President':'Win Myint', 'link':'https://en.wikipedia.org/wiki/Win_Myint_(politician,_born_1951)','source':'https://en.wikipedia.org/wiki/2018_Myanmar_by-elections'}]};

var candidateData = {
    "2010": [{ "candidates": 1084, "partyAbb": "USDP" }, { "candidates": 975, "partyAbb": "NUP" }, { "candidates": 158, "partyAbb": "NDF" }, { "candidates": 153, "partyAbb": "SNDP" }, { "candidates": 78, "partyAbb": "Inde" }, { "candidates": 48, "partyAbb": "DPM" }, { "candidates": 38, "partyAbb": "CPP" }, { "candidates": 33, "partyAbb": "AMRDP" }, { "candidates": 29, "partyAbb": "KPP" }, { "candidates": 27, "partyAbb": "88GSY" }],
    "2012": [{ "candidates": 45, "partyAbb": "USDP" }, { "candidates": 44, "partyAbb": "NLD" }, { "candidates": 22, "partyAbb": "NUP" }, { "candidates": 11, "partyAbb": "NDF" }, { "candidates": 7, "partyAbb": "Inde" }, { "candidates": 4, "partyAbb": "UPP" }, { "candidates": 3, "partyAbb": "DPMNS" }, { "candidates": 3, "partyAbb": "MNC" }, { "candidates": 3, "partyAbb": "NNDP" }, { "candidates": 3, "partyAbb": "UDP" }],
    "2015": [{ "candidates": 1092, "partyAbb": "USDP" }, { "candidates": 1091, "partyAbb": "NLD" }, { "candidates": 743, "partyAbb": "NUP" }, { "candidates": 349, "partyAbb": "NDP" }, { "candidates": 282, "partyAbb": "Inde" }, { "candidates": 282, "partyAbb": "MFDP" }, { "candidates": 262, "partyAbb": "NDF" }, { "candidates": 190, "partyAbb": "SNDP" }, { "candidates": 147, "partyAbb": "SNLD" }, { "candidates": 112, "partyAbb": "KPP" }],
    "2017": [{ "candidates": 19, "partyAbb": "NLD" }, { "candidates": 18, "partyAbb": "USDP" }, { "candidates": 7, "partyAbb": "Inde" }, { "candidates": 7, "partyAbb": "SNDP" }, { "candidates": 7, "partyAbb": "SNLD" }, { "candidates": 6, "partyAbb": "NDP" }, { "candidates": 5, "partyAbb": "NDF" }, { "candidates": 4, "partyAbb": "DP" }, { "candidates": 3, "partyAbb": "NUP" }, { "candidates": 2, "partyAbb": "LNDP" }],
    "2018": [{ "candidates": 12, "partyAbb": "NLD" }, { "candidates": 9, "partyAbb": "USDP" }, { "candidates": 6, "partyAbb": "Inde" }, { "candidates": 4, "partyAbb": "PLP" }, { "candidates": 3, "partyAbb": "ALD" }, { "candidates": 3, "partyAbb": "MPDP" }, { "candidates": 3, "partyAbb": "NUDP" }, { "candidates": 3, "partyAbb": "UEPFDP" }, { "candidates": 2, "partyAbb": "CLD" }, { "candidates": 2, "partyAbb": "DPM" }],
    "2020": [{ "candidates": 1092, "partyAbb": "USDP" }, { "candidates": 1091, "partyAbb": "NLD" }, { "candidates": 743, "partyAbb": "NUP" }, { "candidates": 349, "partyAbb": "NDP" }, { "candidates": 282, "partyAbb": "Inde" }, { "candidates": 282, "partyAbb": "MFDP" }, { "candidates": 262, "partyAbb": "NDF" }, { "candidates": 190, "partyAbb": "SNDP" }, { "candidates": 147, "partyAbb": "SNLD" }, { "candidates": 112, "partyAbb": "KPP" }],
};
...
var parliData = {'2010':[{'id':'NLD','seats':0},{'id':'USDP','seats':58},{'id':'Others','seats':17},{'id':'Military','seats':25}],
                 ...
                 '2020':[{'id':'NLD','seats':59},{'id':'USDP','seats':6},{'id':'Others','seats':10},{'id':'Military','seats':25}],
